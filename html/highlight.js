...
preprocessor:c,strings:s,keywords:u}}}}());hljs.registerLanguage("bash",function(){"use strict";return function(e){
...
},{className:"string",begin:/'/,end:/'/},s]}}}());hljs.registerLanguage("makefile",function(){"use strict";return function(e){
...
end:/$/,keywords:{$pattern:/[\.\w]+/,"meta-keyword":".PHONY"}},s]}}}());hljs.registerLanguage("cmake",function(){"use strict";return function(e){return{
...
},e.HASH_COMMENT_MODE,e.QUOTE_STRING_MODE,e.NUMBER_MODE]}}}());hljs.registerLanguage("c",function(){"use strict";return function(e){
