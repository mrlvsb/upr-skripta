...
[^1]:Většina základních příkazů Linuxu funguje i na macOS, protože macOS je system, odvozený z [UNIXu](https://cs.wikipedia.org/wiki/Unix), stejně jako Linux.
...
Před znakem dolaru (`$`) vždy uvidíte adresář[^2], ve kterém se zrovna v terminálu nacházíte. Odpovídá
...
[^2]: Adresář (nebo taky složka) označuje pojmenovanou sadu souborů umístěnou na nějaké **cestě** (např. `/home/franta/soubor.c` nebo `/mnt/c/users/franta/Desktop/soubor.c`) na
